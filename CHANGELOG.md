...
#### [0.3.6](https://github.com/fulfillmenttools/fulfillmenttools-sdk-typescript/compare/0.3.5...0.3.6)

- build(deps): bump @eslint/plugin-kit and eslint [`#104`](https://github.com/fulfillmenttools/fulfillmenttools-sdk-typescript/pull/104)
- respect arrays as url params [`#103`](https://github.com/fulfillmenttools/fulfillmenttools-sdk-typescript/pull/103)
- Update CODEOWNERS [`#102`](https://github.com/fulfillmenttools/fulfillmenttools-sdk-typescript/pull/102)
- bump dependencies [`45e0b5d`](https://github.com/fulfillmenttools/fulfillmenttools-sdk-typescript/commit/45e0b5d2fd5b0c3d628d4605a4d6f47faa917140)

#### [0.3.5](https://github.com/fulfillmenttools/fulfillmenttools-sdk-typescript/compare/0.3.4...0.3.5)

> 27 May 2025

- chore: Release v0.3.5 [`#101`](https://github.com/fulfillmenttools/fulfillmenttools-sdk-typescript/pull/101)
- chore: fix some Sonar findings [`#71`](https://github.com/fulfillmenttools/fulfillmenttools-sdk-typescript/pull/71)
- Prepare for supplier facilities [`#95`](https://github.com/fulfillmenttools/fulfillmenttools-sdk-typescript/pull/95)
- build(deps): bump esbuild and tsup [`#99`](https://github.com/fulfillmenttools/fulfillmenttools-sdk-typescript/pull/99)
- build(deps-dev): bump @babel/runtime from 7.26.0 to 7.27.1 [`#98`](https://github.com/fulfillmenttools/fulfillmenttools-sdk-typescript/pull/98)
- build(deps-dev): bump @babel/helpers from 7.25.7 to 7.27.1 [`#97`](https://github.com/fulfillmenttools/fulfillmenttools-sdk-typescript/pull/97)
- build(deps): bump undici and release-it [`#96`](https://github.com/fulfillmenttools/fulfillmenttools-sdk-typescript/pull/96)
- build(deps): bump @octokit/plugin-paginate-rest and release-it [`#93`](https://github.com/fulfillmenttools/fulfillmenttools-sdk-typescript/pull/93)
- Feat: add getToken method [`fe81d23`](https://github.com/fulfillmenttools/fulfillmenttools-sdk-typescript/commit/fe81d230f38a9f3d4f3243c97e586e3d05ad805a)

#### [0.3.4](https://github.com/fulfillmenttools/fulfillmenttools-sdk-typescript/compare/0.3.3...0.3.4)

> 19 December 2024

- chore: Release v0.3.4 [`#92`](https://github.com/fulfillmenttools/fulfillmenttools-sdk-typescript/pull/92)
- build: generate provenance statement when publishing to npmjs [`#91`](https://github.com/fulfillmenttools/fulfillmenttools-sdk-typescript/pull/91)
- Require Node &gt;= 18 [`#90`](https://github.com/fulfillmenttools/fulfillmenttools-sdk-typescript/pull/90)
- Docs examples [`#83`](https://github.com/fulfillmenttools/fulfillmenttools-sdk-typescript/pull/83)

#### [0.3.3](https://github.com/fulfillmenttools/fulfillmenttools-sdk-typescript/compare/0.3.2...0.3.3)

> 9 December 2024

- chore: Release v0.3.3 [`#89`](https://github.com/fulfillmenttools/fulfillmenttools-sdk-typescript/pull/89)
- fix: handle Blob correctly [`#88`](https://github.com/fulfillmenttools/fulfillmenttools-sdk-typescript/pull/88)

#### [0.3.2](https://github.com/fulfillmenttools/fulfillmenttools-sdk-typescript/compare/0.3.1...0.3.2)

> 9 December 2024

- chore: Release v0.3.2 [`#87`](https://github.com/fulfillmenttools/fulfillmenttools-sdk-typescript/pull/87)
- feat: Query process by parameters [`#85`](https://github.com/fulfillmenttools/fulfillmenttools-sdk-typescript/pull/85)
- feat(CON-474): Make logging configurable [`#75`](https://github.com/fulfillmenttools/fulfillmenttools-sdk-typescript/pull/75)
- fix: process result of create listing call correctly [`#84`](https://github.com/fulfillmenttools/fulfillmenttools-sdk-typescript/pull/84)
- fix: handle responses that are not a json [`0f614e9`](https://github.com/fulfillmenttools/fulfillmenttools-sdk-typescript/commit/0f614e97c3bb14c2ab0c80c52c82cc66ad601a88)

#### [0.3.1](https://github.com/fulfillmenttools/fulfillmenttools-sdk-typescript/compare/0.3.0...0.3.1)

> 18 November 2024

- chore: Release v0.3.1 [`#82`](https://github.com/fulfillmenttools/fulfillmenttools-sdk-typescript/pull/82)
